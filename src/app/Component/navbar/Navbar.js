                    ...
                    nav.map(link => {
                        return (
                            <li className="nav-item" key={link.id}>
                                <Link to={link.path} className="nav-link" style={link.id === 6 ? { padding: "5px 20px", border: "1px solid #212832", borderRadius: "5px" } : null} >{link.name}</Link>
                            </li>
                        )
                    })
                }
